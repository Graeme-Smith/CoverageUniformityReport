...
main() {
    ...
    dx download project-ByfFPz00jy1fk6PjpZ95F27J:file-FjP62980jy1yfPZBKK7Z2pf2
    ...
    docker run -v /home/dnanexus:/home --rm graemesmith/uniform-coverage Rscript "/src/sambamba_exon_coverage.R"  "/home/coverage/raw_output/" "/home/coverage/uniformity_metrics"
